    ...
    return (
        <div className="mx-auto max-w-screen-md w-full flex flex-col justify-start">
            <div className="header-grid mb-6">
                ...
                <h1 className="text-white text-center text-2xl font-helvetica-neue">
            ...
            <div className="flex flex-col justify-start items-stretch max-w-screen-sm mx-auto">
                <div className="flex flex-col justify-start items-start relative w-max p-4 rounded-lg bg-gray-800">
                    <span
                        className="text-white font-helvetica-neue text-sm mb-4">Detailed description of automation</span>
                    <textarea rows={4} cols={60}
                              className="bg-gray-700 text-white font-helvetica-neue text-sm p-2 rounded-lg resize-none"/>
                ...
                <button
                    className="mt-5 px-4 py-2 text-white hover:cursor-pointer transition-colors duration-300 hover:bg-indigo-600 rounded-full font-helvetica-neue bg-indigo-500">
                    New action
                </button>
            </div>
        </div>
