...
export function SidebarMenuItem(props: { page: Page }) {
    ...
    return (
        <div
            className="py-1 px-6 rounded-lg m-1 hover:bg-gray-200 dark:hover:bg-gray-900 border-[1px] border-transparent border-solid hover:border-blue-500 transition-colors duration-200 hover:cursor-pointer flex text-nowrap justify-start select-none items-center"
