...
export function AnnotatedIcon(props: {
    ...
    return (
        ...
        <span
            className="group-hover:max-w-[150px] text-black select-none text-sm text-nowrap group-hover:px-2 group-hover:py-1 group-hover:opacity-100 opacity-0 bg-gray-200 rounded-xl max-w-[0px] transition-all duration-500 ease-in-out overflow-hidden group-hover:mx-0.5">
            {props.annotation}
        </span>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5}
                 className={'w-8 h-8 my-2 mx-1 p-1 stroke-black shrink-0 rounded-full group-hover:bg-gray-200' +
