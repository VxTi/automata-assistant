...
const IconWrapper = (props: { props: BasicIconProps, children: ReactNode }) => (
    <svg {...props.props} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        {props.children}
    </svg>
);

const StrokePath = (props: { d: string }) => (
    <path strokeLinecap="round" strokeLinejoin="round" className="stroke-black fill-none dark:stroke-white"
          d={props.d}/>
);
