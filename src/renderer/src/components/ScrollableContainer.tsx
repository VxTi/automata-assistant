...
export function ScrollableContainer(props: {
    children: ReactNode, className?: string, blurEdges?: boolean, ref?: RefObject<HTMLDivElement>
}) {

    return (
        <div
            ref={props.ref}
            className={`flex flex-col justify-start items-center grow gap-4 overflow-y-auto ${props.blurEdges ? 'h-gradient-clip' : ''}`}>
